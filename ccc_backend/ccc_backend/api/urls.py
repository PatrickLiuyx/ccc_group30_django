...
from ccc_backend.ccc_backend.api.views import *
from ccc_backend.ccc_backend.api.views.yangjing import *
from ccc_backend.ccc_backend.api.views.yilin import *
...
# show static file
urlpatterns += [
    re_path(r'^wordcloud/$', WC_1, name='wc'),
]
urlpatterns += static('/wordcloud/', document_root=settings.MEDIA_ROOT)
